            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    if (isset($_SESSION['user_id'])) {
                        ...
                        $bell_stmt = $pdo->prepare("SELECT COUNT(*) FROM notifications WHERE user_id = :user_id AND status = 'Unread'");
                        $bell_stmt->execute(['user_id' => $_SESSION['user_id']]);
                    ...
                    <a href="/notifications/index.php" class="relative p-1 rounded-full text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 transition focus:outline-none">
                        ...
                        <?php if ($unread_count > 0): ?>
                            <span class="absolute top-0 right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-bold leading-none text-white transform translate-x-1/4 -translate-y-1/4 bg-red-600 rounded-full"><?php echo $unread_count > 99 ? '99+' : $unread_count; ?></span>
                        <?php endif; ?>
                    </a>
