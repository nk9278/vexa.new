...
checkAuth(['Employee', 'Photographer', 'Graphic Designer', 'Video Editor', 'Content Writer', 'Content Approval', 'Web Developer', 'Other Employees', 'Sales']);

include __DIR__ . '/header.php';
?>

<div class="px-4 py-5 sm:px-6">
    <h1 class="text-3xl font-bold leading-tight text-gray-900">Employee Dashboard</h1>
</div>
