...
// Check state to prevent CSRF and one-time use
if (!isset($_GET['state']) || !isset($_SESSION['oauth_state']) || $_GET['state'] !== $_SESSION['oauth_state']) {
    $_SESSION['error_msg'] = "OAuth state mismatch or link already used. Please try connecting again.";
    redirect('/agency/google-drive.php');
}
unset($_SESSION['oauth_state']); // Invalidate state to prevent reuse
